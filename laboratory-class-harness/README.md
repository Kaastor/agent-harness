# Laboratory-Class Harness

A working Pi extension for controlled, evidence-producing agent experiments.

This directory explores how Pi can be customized to observe an agent session
and apply a deterministic submission gate without replacing Pi's own
interactive harness. It is laboratory-class: intended for bounded, repeatable
experiments with inspectable evidence, not yet as a production agent platform.
